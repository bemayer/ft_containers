...
//	std::cout << "------------------------------------------------------------";
//	std::cout << std::endl;
//	std::cout << "------------ Map with string as keys tests -----------------";
//	std::cout << std::endl;
//	std::cout << "------------------------------------------------------------";
//	std::cout << std::endl;
//	ft::map<std::string, bool> myStringMap;
...
//	long    microseconds;
//	long    elapsed;
//	std::cout << "Time for 10 000 000 insertions, consultations, iterations and "
//				 "deletions with ft: ";
//	gettimeofday(&begin, 0);
//	ft::map<int, bool> myTimedMap_ft;
...
//				 "and deletions with std: ";
//	gettimeofday(&begin, 0);
//	std::map<int, bool> myTimedMap_std;
//	for (int i = 0; i < 1000000; i++)
//		myTimedMap_std[i];
//	for (int i = 0; i < 1000000; i++)
//		myTimedMap_std[i];
//	for (std::map<int, bool>::iterator iter = myTimedMap_std.begin();
//		 iter != myTimedMap_std.end(); iter++)
//	{
//	}
//	for (int i = 0; i < 1000000; i++)
...
//	std::cout << elapsed << "ms" << std::endl;
	...
	mp1.print_tree();
	for (ft::map<char, int>::iterator it = mp1.begin(); it != mp1.end(); it++)
		std::cout << it->first;
	std::cout << std::endl;
	cmp(mp1, mp1); // 0
	cmp(mp1, mp2); // 1
